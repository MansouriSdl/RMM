    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssignementDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reportings_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reportings_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reportings_Sections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachements_Reportings_ReportingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachements_ReportingId",
                table: "Attachements",
                column: "ReportingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reportings_EmployeeId",
                table: "Reportings",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Reportings_ProductId",
                table: "Reportings",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Reportings_SectionId",
                table: "Reportings",
                column: "SectionId");
        }
